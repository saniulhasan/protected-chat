...
/*     max users permitted variable */
    ...
    const CreateRoom = event => {
        ...
        socket.emit('createRoom', { name, password, maxUsers });
                ...
                <div className="bg-dark-2 md:shadow-lg shadow-none p-8 pb-0 rounded-xl w-80 md:w-[fit-content]">
                    ...
                    <form onSubmit={CreateRoom} className="my-8 w-full md:w-96 h-auto">
                        <div className="relative mb-2">
                            ...
                            <input id="name" autoComplete='off' className=" bg-dark-3 transition-all duration-200 w-full rounded-lg p-3 border border-gray-300/10 focus:border-gray-700 outline-none ring-none" type="text" />
                        </div>
                        <div className="relative mb-2">
                            ...
                            <input id="password" autoComplete='off' className=" bg-dark-3 transition-all duration-200 w-full rounded-lg p-3 border border-gray-300/10 focus:border-gray-700 outline-none ring-none" type="text" />
                        </div>
                        <div className="relative mb-2">
                            ...
                            <input id="maxUsers" autoComplete='off' placeholder={maxusers} type="number" min="2" max="30" className=" bg-dark-3 transition-all duration-200 w-full rounded-lg p-3 border border-gray-300/10 focus:border-gray-700 outline-none ring-none" />
                        </div>
